...
import fire.base.chat.messenger.base.BaseViewModel
...
class MessengerViewModel(
        ...
        fcmListenerServiceInteractor
                ...
                .subscribe {
                    it?.let { fireBaseChatMessage: FireBaseChatMessage ->
                        lastReceivedMessage.value = MessageItem(
    ...
    @SuppressLint("CheckResult")
    fun sendMessage(topic: String = TOPIC_FOR_REQUEST, name: String = "you", message: String = "", profileColor: String = "#D81B60") {
